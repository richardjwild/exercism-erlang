...
'6_a_dart_lands_outside_the_target_on_the_other_side_test'() ->
    ?assertEqual(0,
        darts:score(-1.53e+1, 1.31999999999999992895e+1)).

'7_a_dart_lands_just_in_the_border_of_the_target_on_the_other_side_test'() ->
    ?assertEqual(1, darts:score(-10, 0)).

'8_a_dart_lands_in_the_middle_circle_on_the_other_side_test'() ->
    ?assertEqual(5, darts:score(3, -3.7)).

'9_a_dart_lands_right_in_the_border_between_outside_and_middle_circles_on_the_other_side_test'() ->
    ?assertEqual(5, darts:score(0, -5)).

'10_a_dart_lands_in_the_inner_circle_on_the_other_side_test'() ->
    ?assertEqual(10, darts:score(-0.5, -0.5)).
